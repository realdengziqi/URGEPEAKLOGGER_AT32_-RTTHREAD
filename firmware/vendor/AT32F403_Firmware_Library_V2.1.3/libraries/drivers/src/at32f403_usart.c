...
/**
  ...
  * @note   clock config are not available for UART4, UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
...
/**
  ...
  * @note   clock enable are not available for UART4, UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2, USART3.
  * @param  new_state: TRUE or FALSE
...
/**
  ...
  * @note   the division are not available for UART4, UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2, USART3.
...
/**
  ...
  * @note   the smart card mode are not available for UART4, UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2, USART3.
...
/**
  ...
  * @note   the smart card nack are not available for UART4, UART5.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1, USART2, USART3.
